...
if (isset($_GET['search'])) {
    ...
    $sql = "SELECT * FROM belongings WHERE name LIKE '%$searchQuery%'";
} else {
...
@media (max-width: 768px) {
    .search-bar input[type="text"] {
        width: 90%; /* Input slightly smaller on medium screens */
    }

    .search-bar button {
        width: 90%; /* Button slightly smaller on medium screens */
    }
}

@media (max-width: 480px) {
    .search-bar input[type="text"] {
        width: 90%; /* Input field takes up most of the screen width on small screens */
    }

    .search-bar button {
        width: 90%; /* Button width also takes up most of the screen width */
    }
}
...
.belonging-item img {
    max-width: 100%;
    height: 200px; /* Adjust image size for a balanced layout */
    object-fit: cover;
    border-radius: 12px;
    margin-bottom: 15px;
...
.belonging-item .description {
    ...
    max-height: 100px; /* Limit the height to fit the card */
    margin-bottom: 10px;
}
...
@media (max-width: 768px) {
    ...
    .belonging-item img {
        height: 180px; /* Smaller images for smaller screens */
    }
}
...
@media (max-width: 768px) {
    h1 {
        font-size: 2em; /* Slightly smaller font size on medium screens */
    }
}
