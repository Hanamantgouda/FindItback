...
<body>
    <div class='email-container'>
        ...
        <div class='email-body'>
            <p>Hi $claimer_name,</p>
            <P>Your claim request for the belonging $belonging_name has been approved by admin and is currently with <strong>$uploader_name</strong>. To retrieve your lost item, please reach out to them directly.</p>
            <p>You can contact the uploader at the following phone number: <strong>$uploader_phone</strong>.</p>
